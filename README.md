This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app)[![Build Status](https://travis-ci.org/jacksontong/redux-react-testing.svg?branch=master)](https://travis-ci.org/jacksontong/redux-react-testing)
